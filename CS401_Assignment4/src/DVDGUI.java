...
public class DVDGUI implements DVDUserInterface{
	...
	private void doAddOrModifyDVD() {
		...
		// Request the title
		title = JOptionPane.showInputDialog("Enter title of DVD you want to add or modify: ");
	...
	private void doRemoveDVD() {
		...
		// Request the title
		String title = JOptionPane.showInputDialog("Enter the title of DVD you want to remove: ");
		if (title == null || title.equals("")) {
			return;		// dialog was cancelled
		}
		title = title.toUpperCase();
